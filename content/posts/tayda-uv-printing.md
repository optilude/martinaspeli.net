...
* At this point, I turned all the layers back on to confirm that everything aligned properly. With the "GLOSS-M" layer selected, everything was coloured uniformly "RDG\_GLOSS". Turning that layer off, the colours would come through though the whites still looked like the grayish "RDG\_WHITE". With the "COLOR" layer hidden, everything looked like "RDG\_WHITE".
